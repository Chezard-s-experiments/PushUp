...
mixin _$AuthResponse {
 ...
 AccessTokenPayload get token; UserProfile get user;
...
@useResult
$Res call({
 AccessTokenPayload token, UserProfile user
});


$AccessTokenPayloadCopyWith<$Res> get token;$UserProfileCopyWith<$Res> get user;
...
as AccessTokenPayload,user: null == user ? _self.user : user // ignore: cast_nullable_to_non_nullable
as UserProfile,
  ));
}
/// Create a copy of AuthResponse
...
@override
@pragma('vm:prefer-inline')
$AccessTokenPayloadCopyWith<$Res> get token {
  
  return $AccessTokenPayloadCopyWith<$Res>(_self.token, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( AccessTokenPayload token,  UserProfile user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AccessTokenPayload token,  UserProfile user)  $default,) {final _that = this;
switch (_that) {
case _AuthResponse():
return $default(_that.token,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( AccessTokenPayload token,  UserProfile user)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponse() when $default != null:
return $default(_that.token,_that.user);case _:
  return null;
...
@override final  AccessTokenPayload token;
...
@override $AccessTokenPayloadCopyWith<$Res> get token;@override $UserProfileCopyWith<$Res> get user;
